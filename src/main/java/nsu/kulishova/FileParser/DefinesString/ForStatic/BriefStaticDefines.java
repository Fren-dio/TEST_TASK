package nsu.kulishova.FileParser.DefinesString.ForStatic;

public record BriefStaticDefines() {

    public static String START_BRIEF_STATIC = "It's a brief statistic about data in given input files\n";

    public static String SHORT_STATIC = "Statistic:";
